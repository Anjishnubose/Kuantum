...
"""
def Metropolis(N_sample: int, k_max: int, 
    ...
    probabilities[int(k_current)] = hv.heaviside_fourier_reduced(k_current, k_max, beta)
    ...
    for step in range(N_sample):
        ...
        if k_new not in probabilities:
            probabilities[int(k_new)] = hv.heaviside_fourier_reduced(k_new, k_max, beta)
...
if __name__ == "__main__":
    ...
    sample = Metropolis(N_sample, k_max, beta)
